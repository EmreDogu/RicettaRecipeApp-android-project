...
public class RecipeDescriptionFragment extends Fragment {
    ...
    public static RecipeDescriptionFragment newInstance(String type, String name, String link, String recipedesc, String ingredients, String calories, String time, String favourite, String basket) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_admin_recipe_description, container, false);

...
//Emre Doğu
public class DinnerActivity extends AppCompatActivity implements RecipeFragment.OnAdminRecipeListInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listenerRegistration = db.collection(email).addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                while (i >= 0) {
                    if (recipes.get(i).getType().equals("Akşam Yemeği")) {
                    } else {
    ...
    public void onBackPressed() {
        ...
        if (editRecipeFragment != null) {
            ...
            Intent intent = new Intent(DinnerActivity.this, MealTimeActivity.class);
            startActivity(intent);
        }
    }

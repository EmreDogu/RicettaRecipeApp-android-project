...
//Emre Doğu
public class LunchActivity extends AppCompatActivity implements RecipeFragment.OnAdminRecipeListInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listenerRegistration = db.collection(email).addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                while (i >= 0) {
                    if (recipes.get(i).getType().equals("Öğle Yemeği")) {
                    } else {
    ...
    public void onBackPressed() {
        ...
        if (editRecipeFragment != null) {
            ...
            Intent intent = new Intent(LunchActivity.this, MealTimeActivity.class);
            startActivity(intent);
        }
    }

...
//Emre Doğu
public class DessertsActivity extends AppCompatActivity implements RecipeFragment.OnAdminRecipeListInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listenerRegistration = db.collection(email).addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                while (i >= 0) {
                    if (recipes.get(i).getType().equals("Tatlı")) {
                    } else {
    ...
    public void onBackPressed() {
        ...
        if (editRecipeFragment != null) {
            ...
            Intent intent = new Intent(DessertsActivity.this, DessertsActivity.class);
            startActivity(intent);
        } else {
            Intent intent = new Intent(DessertsActivity.this, MealTimeActivity.class);
            startActivity(intent);
        }
    }

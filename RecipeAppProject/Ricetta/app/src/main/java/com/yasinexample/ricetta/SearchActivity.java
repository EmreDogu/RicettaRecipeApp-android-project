...
//Emre Doğu
public class SearchActivity extends AppCompatActivity implements RecipeFragment.OnAdminRecipeListInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            ft.add(R.id.SearchView, RecipeFragment.newInstance(), "list_recipes");
            ft.commit();
        ...
        searchBox.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (s.length()==0) {
                    ...
                    listenerRegistration = db.collection(email).whereEqualTo("mealName", s.toString()).addSnapshotListener(new EventListener<QuerySnapshot>() {
                        @Override
                        public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                            if (error != null) {
                                Log.e("Firebase", "Error retrieving recipes");
    ...
    public void onAdminRecipeSelected(Recipe newrecipe) {
        ...
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        ft.replace(R.id.SearchView, RecipeDescriptionFragment.newInstance(editingRecipe.getType(), editingRecipe.getMealName(), editingRecipe.getLink(), editingRecipe.getRecipe(), editingRecipe.getIngredients(), editingRecipe.getCalories(), editingRecipe.getCookingTime(), editingRecipe.getFavouriteState(), editingRecipe.getBasketState()), "show_recipe");
